...
class Edrone():
    ...
    def pid(self):
        ...
        y = -(float(self.dest[0]) - float(self.drone_position[0])) * float(self.meter_conv[0])
        x = -(float(self.dest[1]) - float(self.drone_position[1])) * float(self.meter_conv[1])
        self.o = math.atan(y / x)
